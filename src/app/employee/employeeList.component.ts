...
export class EmployeeListComponent {
  ...
  constructor() {
    this.employees = [
      ...
      { code: 'emp105', name: 'Nancy', gender: 'Female', annualSalary: 6500.826, dateOfBirth: '12/15/1982'},
      { code: 'emp106', name: 'Steve', gender: 'Male', annualSalary: 7700.48, dateOfBirth: '11/18/1979'},
    ];
  }
